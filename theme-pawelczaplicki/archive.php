...
/**
 * Szablon archiwum kategorii / tagu / autora.
 * Współdzielony layout z home.php – hero z nazwą archiwum.
 */
...
<div class="pt-40 pb-24 lg:pt-48 pc-archive-main">
	<div class="max-w-7xl mx-auto px-6 md:px-12">
		...
		<div class="mb-20 max-w-4xl">
			<p class="pc-archive-kicker"><?php esc_html_e( 'Baza Wiedzy', 'pawelczaplicki' ); ?></p>
			<h1 class="pc-archive-title">
				<?php echo wp_kses_post( $archive_title ); ?>
			</h1>
			<?php if ( $archive_desc ) : ?>
				<div class="pc-archive-lead">
		...
		if ( ! empty( $categories ) ) :
			...
			<div class="pc-archive-filters">
				<a href="<?php echo esc_url( $blog_url ); ?>" class="pc-archive-filter-btn <?php echo ! $current_cat ? 'pc-archive-filter-btn--active' : ''; ?>">
					<?php esc_html_e( 'Wszystkie', 'pawelczaplicki' ); ?>
				</a>
				<?php foreach ( $categories as $cat ) : ?>
					<a href="<?php echo esc_url( get_category_link( $cat->term_id ) ); ?>" class="pc-archive-filter-btn <?php echo (int) $current_cat === (int) $cat->term_id ? 'pc-archive-filter-btn--active' : ''; ?>">
		...
		<?php else : ?>
			<p class="pc-archive-empty"><?php esc_html_e( 'Brak wpisów w tej kategorii.', 'pawelczaplicki' ); ?></p>
		<?php endif; ?>
